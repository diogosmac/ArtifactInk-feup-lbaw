    ...
    <main class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="container">
        ...
        <div class="mb-4 d-flex justify-content-between align-items-center flex-wrap border-bottom mt-2">
          ...
          <button onclick="editGeneralInfo()" type="button" class="btn button">
            Edit Information
          </button>
        </div>
        <div class="mt-2">
          ...
          <div id="infoSubmitButtons" class="d-flex mt-2 flex-row-reverse my-2 info-submit-buttons">
            <button onclick="saveGeneralInfo()" type="button" class="btn button mx-1">
              Save Information
            </button>
            <button onclick="cancelGeneralInfo()" type="button" class="btn btn-link a_link mx-1">
              Cancel
            </button>
          </div>
        </div>
