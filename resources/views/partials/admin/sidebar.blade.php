...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
  <div class="sidebar-sticky d-flex flex-column">
    ...
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Route::is('admin.sales*')) ? 'active' : '' }}" href="{{ route('admin.sales.home') }}">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Route::is('admin.newsletter*')) ? 'active' : '' }}" href="{{ route('admin.newsletter') }}">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Route::is('admin.info*')) ? 'active' : '' }}" href="{{ route('admin.info') }}">
    ...
    <div class="mt-auto mb-3">
      <a class="nav-link" onclick="document.querySelector('#admin-signout-form').submit();" style="cursor: pointer">
